...
if($user->getAmount('water_pail') < 1) {
	$errors[] = 'You need a water pail to water your fields.';
	$valid = false;
}
...
if($valid) {
	//Hoe is in use
	$user->updateInventory('water_pail', -1, true);
	...
	//Insert jobs
	$query = "INSERT INTO jobs_farming VALUES ($work, $id, 'Water', '$date')";
	runDBQuery($query);
	...
	$notices[] = 'Your farm is now being watered.';
